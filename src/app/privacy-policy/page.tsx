...
const sections = [
  ...
  },
  {
    ...
    content: 'Depending on how you interact with us or which of the Services you use, we may use personal information for the following purposes:',
    bullets: [
  ...
  },
  {
    ...
    content: 'In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:',
    bullets: [
  ...
  },
  {
    ...
    content: 'Depending on where you live, you may have some or all of the rights listed below in relation to your personal information. However, these rights are not absolute, may apply only in certain circumstances and, in certain cases, we may decline your request as permitted by law.',
    bullets: [
    ...
    footer: 'You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. We will not discriminate against you for exercising any of these rights. We may need to verify your identity before we can process your requests, as permitted or required under applicable law.',
  },
  {
    title: 'Complaints',
      ...
      <main>
        ...
        <section className="relative h-60 md:h-[300px] w-full overflow-hidden bg-linear-to-br from-[#00473c] via-[#00594a] to-[#003a31]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center">
            ...
            <p className="mt-3 text-white/80 text-sm md:text-base">Last updated: April 22, 2026</p>
          </div>
        </section>
        ...
        <section className="px-4 md:px-6 lg:px-20 py-10 md:py-14">
          <div className="max-w-[860px] mx-auto">
            <p className="text-[#444] leading-relaxed text-base md:text-[17px]">
              yournextblinds operates this store and website, including all related information, content,
              features, tools, products and services, in order to provide you, the customer, with a curated
              shopping experience (the &ldquo;Services&rdquo;). yournextblinds is powered by Shopify, which
              enables us to provide the Services to you. This Privacy Policy describes how we collect, use,
            ...
            <p className="mt-4 text-[#444] leading-relaxed text-base md:text-[17px]">
          ...
          <div className="max-w-[860px] mx-auto space-y-10">
                ...
                {section.bullets && (
                  <ul className="list-disc list-outside pl-5 space-y-2 mb-4">
                    {section.bullets.map((bullet, i) => (
                      <li key={i} className="text-[#444] leading-relaxed text-base md:text-[17px]">
                        {bullet}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <p className="text-[#444] leading-relaxed text-base md:text-[17px]">
                ...
                would like to exercise any of the rights available to you, please call or email us at{' '}
                <a
